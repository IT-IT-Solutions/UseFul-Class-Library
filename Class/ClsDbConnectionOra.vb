...
Public Class ClsDbConnectionOra
    ...
    Public ConDbUCSAppsx As OracleConnection = New OracleConnection("Data Source=(DESCRIPTION= (ADDRESS = (PROTOCOL = TCP)(HOST =172.16.15.20) (PORT = 1521))(CONNECT_DATA = (SERVER = dedicated)(SERVICE_NAME = UCSPRD)));User ID=apps;Password=gul_oracle_apps;")
    ...
    Public ConDbUCSApps As OracleConnection = New OracleConnection("Data Source=(DESCRIPTION= (ADDRESS = (PROTOCOL = TCP)(HOST =localhost) (PORT = 1521))(CONNECT_DATA = (SERVER = dedicated)(SERVICE_NAME = XE)));User ID=APPS;Password=APPS;")
